...
def main():
    ...
    arg_parser = argparse.ArgumentParser(
        description="Optimize a majority vote with CB-Boost")
    ...
    arg_parser.add_argument(
        "--max-iteration", metavar="max-iteration", default=200, type=int,
    ...
    max_iteration = arg_list.max_iteration
    ...
    # We learn the weights of the MV with CB-Boost
